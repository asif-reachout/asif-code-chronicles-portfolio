              ...
              <CardContent className="text-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="p-6 bg-slate-50 dark:bg-slate-700 rounded-lg shadow-sm">
                    ...
                    <p className="text-slate-600 dark:text-slate-300">5-Star Rating</p>
                  </div>
                </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {projects.map((project, index) => (
                <Card key={project.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                  <CardHeader>
                    <CardTitle className="group-hover:text-blue-500 transition-colors text-slate-900 dark:text-slate-100">
                      {project.title}
                    </CardTitle>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tech.map((tech) => (
                        <Badge key={tech} variant="outline" className="text-xs border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400">
                          {tech}
                        </Badge>
                      ))}
                    </div>
                    <div className="flex gap-2">
                      <Button size="sm" variant="outline" className="group/btn border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700">
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                <div key={exp.company} className="relative pl-8 border-l-2 border-blue-300 dark:border-blue-700">
                  <div className="absolute -left-2 top-0 w-4 h-4 bg-blue-500 rounded-full"></div>
                  <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                    <CardHeader>
                      <CardTitle className="text-xl text-slate-900 dark:text-slate-100">{exp.position}</CardTitle>
                      <CardDescription className="text-lg font-medium text-blue-500 dark:text-blue-400">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                <CardHeader>
                  <CardTitle className="text-slate-900 dark:text-slate-100">Education</CardTitle>
                </CardHeader>
                <CardContent>
                  <h3 className="font-semibold text-lg mb-2 text-slate-900 dark:text-slate-100">BS Software Engineering</h3>
                  <p className="text-blue-500 dark:text-blue-400 mb-1">Virtual University of Pakistan</p>
                  <p className="text-slate-600 dark:text-slate-400">2021 – 2025</p>
                </CardContent>
              </Card>
              <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                <CardHeader>
                ...
                <CardContent className="space-y-3">
                  <div>
                    <h3 className="font-semibold text-slate-900 dark:text-slate-100">Cisco Networking Essentials</h3>
                    <p className="text-slate-600 dark:text-slate-400 text-sm">2023</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-slate-900 dark:text-slate-100">Microsoft Exam 70-480</h3>
